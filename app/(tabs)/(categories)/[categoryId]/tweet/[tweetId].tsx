...
import { getTweet, getTweetReplies, createTweet, recordTweetImpression } from '@/services/api/tweetService';
...
export default function CategoryTweetDetailScreen() {
  ...
  const handleReplyPress = useCallback((replyTweet: Tweet) => {
  ...
  return (
    ...
    >
      ...
      <View style={[styles.inputContainer, { borderTopColor: colors.border }]}>
        <ChatInput placeholder="返信を入力..." onSend={handleSendReply} />
      </View>
